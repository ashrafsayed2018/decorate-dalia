      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 gap-y-16">
        ...
        <div className="contact-info">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="flex items-center gap-3">
              <FontAwesomeIcon icon={faPhone} className="text-2xl textColor" />
              <p className="text-xl textColor">{SiteInfo.mobileNumber}</p>
            </div>
            <div className="flex items-center gap-3">
              <FontAwesomeIcon
                icon={faEnvelope}
              ...
              />
              <p className="text-xl textColor">xyz@gmail.com</p>
            </div>
            <div className="flex items-center gap-3">
              <FontAwesomeIcon icon={faClock} className="text-2xl textColor" />
              <p className="text-xl textColor">من 9:00 صباحاً حتى 6:00 مساءً</p>
            </div>
          </div>
        </div>
        {/* contact form */}
